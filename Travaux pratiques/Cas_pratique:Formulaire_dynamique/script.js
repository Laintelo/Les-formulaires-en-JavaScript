...
function submitForm(event){
    ...
    // Vérification du nom
    if (!CheckNom){
        er_nom.innerHTML = "❌ veuillez renseigner un nom valide !";
        er_nom.style.color = "red";
        nomInput.focus()
        return;
    }
    ...
    if (!CheckPrenom){
        er_prenom.innerHTML = "❌ veuillez renseigner un prénom valide !";
        er_prenom.style.color = "red";
        prenomInput.focus()
        return;
    }
    ...
    if (!CheckTel){
        er_tel.innerHTML = "❌ veuillez renseigner un numéro de telephone valide !";
        er_tel.style.color = "red";
        telInput.focus()
        return;
    }
    // Validation de la nationalite
    if(!CheckNat){
        er_nat.innerHTML = "❌ veuillez sélectionner une nationnalité valide !";
        er_nat.style.color = "red";
        natInput.focus()
        return;
    }
